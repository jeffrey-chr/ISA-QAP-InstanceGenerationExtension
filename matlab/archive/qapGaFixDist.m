function [xout] = qapGaFixDist(target, model, features, params)
...
% Initial population: Based on closest instances to target point
    ...
    [xout,fval,~,output,population,scores] = ga(@(x) qapObjectiveFixDist(x,otherparams,flowgen,distfixed,target,model,features), 3, [], [], [], [], lb, ub, [], intcon, options);
