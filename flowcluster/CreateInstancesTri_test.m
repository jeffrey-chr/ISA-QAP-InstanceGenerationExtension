...
instTypes = {
              %[2,5], 8;
              %[2,6], 8;
              %[3,3,3,3], @() genDistHypercube(3,4,20), @(t) genFlowTcycle([3,3,3,3],20,g,t), 'hyper', 5;
              [8,10], @() genDistDrexx(10,8), @(t) genFlowTcycle([8,10],20,g,t), 'drez', 10;
...
for i = 1:size(instTypes,1)
    ...
    for count = 1:ninst
        ...
        name = strcat('tritest',num2str(n),'_D',instTypes{i,4},'_',num2str(count));
